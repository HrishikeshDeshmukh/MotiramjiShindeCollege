        ...
        <div className='mt-8'>
            ...
            <div className='w-full grid md:grid-cols-2 bg  grid-cols-1'>
                ...
                <div className='flex justify-center items-center flex-col xl:p-4 lg:m-3 xl:mx-10'>
                    ...
                    <p className='xl:px-3 max-sm:px-3 lg:text-sm xl:text-base   max-sm:text-slate-400' >Established in 1995, Shri Awadhut Bahuuddeshiya Sewa Sanstha, Wardha has emerged as a cornerstone of educational excellence, providing a ray of hope and a platform for personal and professional growth for students across the Wardha region. The institute serves students from diverse areas such as Mandgaon, Samudrapur, Hinganghat, and other neighboring regions, bridging the gap between urban and rural education.
